...
**版数:** 0.1  
**作成日:** 2026年6月  
**参照:** [Staddress API リファレンス](https://staddress.com/api) / 別紙1 業務仕様書  
...
最終的には別紙1で定義された **汎用 AI エージェント** が、これらの SDK / CLI を内部で利用する。
...
別紙1の汎用 AI エージェント（`agent/`）は、内部で **Python SDK または Node.js SDK** を Tool 実装層として利用する。
...
| **6** | 2026年8月–9月 | AI エージェント本体（別紙1） |
| **7** | 2026年9月–10月 | MCP / 連携仕様書 / 検収 |
